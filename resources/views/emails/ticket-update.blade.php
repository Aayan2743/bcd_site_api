                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <div style="background-color: #f8fafc; padding: 25px; border-radius: 8px; margin: 25px 0; border-left: 5px solid #1e40af;">
                                <h3 style="margin: 0 0 20px 0; color: #d97706;">Ticket Details</h3>
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td style="padding: 8px 0; color: #666666; width: 40%;">Ticket No</td>
                                        <td style="padding: 8px 0; color: #d97706; font-weight: bold;">{{ $ticket->ticket_no }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0;">
                                            <span style="color: {{ $ticket->status === 'closed' ? '#ef4444' : '#16a34a' }}; font-weight: bold;">
